...
imagem_carro_player = redimensionamento_Imagens("carro_player.png", 1.3)
imagem_carro1 = redimensionamento_Imagens("carro1.png", 1.3)
imagem_carro2 = redimensionamento_Imagens("carro2.png", 1.3)
imagem_carro3 = redimensionamento_Imagens("carro3.png", 1.3)
imagem_carro4 = redimensionamento_Imagens("carro4.png", 1.3)
imagem_carro5 = redimensionamento_Imagens("carro5.png", 1.3)
imagem_carro6 = redimensionamento_Imagens("carro6.png", 1.3)
imagem_carro7 = redimensionamento_Imagens("carro7.png", 1.3)
imagem_carro8 = redimensionamento_Imagens("carro8.png", 1.3)
imagem_carro9 = redimensionamento_Imagens("carro9.png", 1.3)
imagem_carro10 = redimensionamento_Imagens("carro10.png", 1.3)